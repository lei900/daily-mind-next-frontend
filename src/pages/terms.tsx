  ...
  return (
    <>
      ...
      <Container sm css={{ px: "$12", mt: "$8", "@xsMax": { px: "$10" } }}>
        ...
        <Spacer y={1.5} />
        <Text size="$md">
          この利用規約（以下、「本規約」といいます。）は、Daily Mind
          の運営者（以下、「運営者」といいます。）が本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
        </Text>
        <Spacer y={1} />
        <Text size="$md">
          Daily Mind
        ...
        <ol className="list-decimal pl-8">
          ...
          <li>
            <Text size="$md">
              ユーザーが外部サービスのID等を利用して本サービスに登録した場合、そのID等の登録、利用については、外部サービスが規定する各規約の定めに従うものとし、運営者はその内容について責任を負いません。
            </Text>
          </li>
        </ol>
        <Spacer y={1} />
        ...
        <ol className="list-decimal pl-8">
          <li>
            <Text size="$md">法令または公序良俗に違反する行為</Text>
          </li>
          <li>
            <Text size="$md">犯罪行為に関連する行為</Text>
          </li>
          <li>
            <Text size="$md">
          ...
          <li>
            <Text size="$md">本サービスの運営を妨害するおそれのある行為</Text>
          </li>
          <li>
            <Text size="$md">
          ...
          <li>
            <Text size="$md">不正アクセスをし、またはこれを試みる行為</Text>
          </li>
          <li>
            <Text size="$md">
          ...
          <li>
            ...
            <ol className="list-decimal pl-8">
              <li>
                <Text size="$md">過度に暴力的な表現</Text>
              </li>
              <li>
                <Text size="$md">露骨な性的表現</Text>
              </li>
              <li>
                <Text size="$md">
          ...
          <li>
            ...
            <ol className="list-decimal pl-8">
              ...
              <li>
                <Text size="$md">性行為やわいせつな行為を目的とする行為</Text>
              </li>
              <li>
                <Text size="$md">
          ...
          <li>
            <Text size="$md">宗教活動または宗教団体への勧誘行為</Text>
          </li>
          <li>
            <Text size="$md">その他、運営者が不適切と判断する行為</Text>
          </li>
        </ol>
        <Spacer y={1} />
        <Text b size="$xl">
        ...
        <ol className="list-decimal pl-8">
          <li>
            ...
            <ol className="list-decimal pl-8">
              <li>
                <Text size="$md">本規約のいずれかの条項に違反した場合</Text>
              </li>
              <li>
                <Text size="$md">
