...
const Guide = () => {
  ...
  return (
    <Container sm css={{ px: "$12", mt: "$8", "@xsMax": { px: "$10" } }}>
      ...
      <Text size="$lg">つまり、自動的に根拠なく思い浮かぶ考えのことです。</Text>
      <Spacer y={1} />
      <Text size="$lg">
        その「自動思考」は、私たちがその出来事に対しての解釈でもあります。
      </Text>
      <Text size="$lg">その解釈によって、気持ちが大きく動揺したりします。</Text>
      <Spacer y={1} />
      <Text size="$lg">
      ...
      >
        <Collapse.Group>
          ...
          <Collapse title="6. 心のフィルター">
            <Text b>定義：</Text>
            <Text>良いことを全て無視して、悪いことだけに注目してしまう。</Text>
            <Spacer y={1} />
            <Text b>具体例：</Text>
            <Text>
          ...
          <Collapse title="11.感情による決めつけ">
            ...
            <Spacer y={1} />
            <Text b>具体例：</Text>
            <Text>「嫌な感じがするから、きっと何か悪いことが起こった。」</Text>
            <Text>
      ...
      >
        <Card.Body>
          <Row align="center">
            <Image alt="今日の気持ち" src={diaryIcon} height={80} width={100} />
            <Spacer x={1} />
            <h2 className="title sm:text-2xl text-xl font-bold text-gray-700">
              今日の気持ち
            </h2>
